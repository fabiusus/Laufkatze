...
m1_sim = 1;
x_soll = 2;
Q = [diag([10000,0.01,5,800,0.01,100,0.01,100]), diag([10000,1,400,400,0.01,100,0.01,100]), diag([10000,0.01,5,800,0.01,100,0.01,100]), diag([10000,0.001,50,800,0.01,100,0.01,100]), diag([10000,0.01,5,800,0.01,100,0.01,100]), diag([10000,0.01,5,800,0.01,100,0.01,100])];
S = [3000, 3000, 5000, 20, 20, 20];
obs_mult = [1.5, 1.5, 5.0, 5.0, 7.0, 7.0];
