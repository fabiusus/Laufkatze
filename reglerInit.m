...
m1_sim = 1.1;
x_soll = 0.2;
Q = [diag([10000,1,50,40,0.1,10,1,10]), diag([5000,1,500,400,0.1,10,1,10]), diag([10000,0.01,5,800,0.01,100,0.01,100]), diag([10000,0.001,50,800,0.01,100,0.01,100]), diag([10000,0.01,5,800,0.01,100,0.01,100]), diag([10000,0.01,5,800,0.01,100,0.01,100])];
S = [3000, 3000, 5000, 20, 20, 20];
obs_mult = [1.9, 2, 5.0, 5.0, 7.0, 7.0];
